...
\leftheader{%
  ...
  \begin{tabular}{c} % Inicia una tabla con una columna centrada ('c')
    {\Huge\bfseries\sffamily Hernan Enrique Noriega} \\[2mm]
    Institute of Physics \& Institute of Physical Sciences, UNAM  \\
    \textit{Phone}: $+57$\, $777$-$557$-$8085$ \\[3mm]
...
\makerubric{research_internships}
\makerubric{awards}
\input{publications}
\makerubric{softwares}
\makerubric{talks}
\makerubric{scientific_collaborations}
\makerubric{service}
\makerubric{teaching}
\makerubric{outreach}
\makerubric{skills}
